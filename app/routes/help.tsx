  ...
  return (
    <PageShell title="How Fog of Walk works">
      ...
      <PageSection title="Workflow">
        <ol className="space-y-3 text-sm leading-relaxed text-muted-foreground">
          <li className="flex gap-3">
            ...
            <span>
              <strong className="text-foreground">Import activity files</strong> — upload{" "}
              <code className="rounded bg-muted px-1 py-0.5 text-xs">.gpx</code> or{" "}
              <code className="rounded bg-muted px-1 py-0.5 text-xs">.fit</code> files from your
              device. Multiple files are supported; you can add more at any time.
            </span>
          </li>
          <li className="flex gap-3">
            <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-orange-500/20 text-xs font-bold text-orange-400">
            ...
            <span>
              <strong className="text-foreground">Fog clears along your routes</strong> — a 100 m
              corridor is revealed around each track. Enable <em>Fill loops</em> to also clear the
              interior of closed loops (e.g. a park circuit).
            </span>
          </li>
          <li className="flex gap-3">
            <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-orange-500/20 text-xs font-bold text-orange-400">
            ...
            <span>
              <strong className="text-foreground">Add photos (optional)</strong> — upload JPEG or
              HEIC photos. They appear as markers on the map at the location where you were when
              the photo was taken, matched by timestamp.
            </span>
          </li>
          <li className="flex gap-3">
            <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-orange-500/20 text-xs font-bold text-orange-400">
            ...
            <span>
              <strong className="text-foreground">Everything stays in your browser</strong> — no
      ...
      <PageSection title="Supported file formats">
        <div className="mb-4 rounded-lg border border-border bg-muted/50 p-4">
          <h3 className="mb-1 font-semibold text-foreground">
            GPX{" "}
            <span className="text-xs font-normal text-muted-foreground">GPS Exchange Format</span>
          </h3>
          ...
          <ul className="space-y-1 text-sm text-muted-foreground">
            <li>
              <strong className="text-foreground">Strava</strong> — Activity page → ⋯ → Export GPX
            </li>
            <li>
              <strong className="text-foreground">Garmin Connect</strong> — Activity → ⋯ → Export
              Original (or Export GPX)
            </li>
            <li>
              <strong className="text-foreground">AllTrails</strong> — Activity → Export → GPX
            </li>
            <li>
              <strong className="text-foreground">Komoot</strong> — Tour page → ↓ → GPX
            </li>
            <li>
              <strong className="text-foreground">Wahoo</strong> — Workout → Export → GPX
            </li>
            <li>
              <strong className="text-foreground">Apple Watch</strong> — via WorkOutDoors or
              HealthExport apps
            </li>
            <li>
              <strong className="text-foreground">Polar, Suunto, COROS</strong> — check the
        ...
        <div className="rounded-lg border border-border bg-muted/50 p-4">
          ...
          <ul className="space-y-1 text-sm text-muted-foreground">
            ...
            <li>
              <strong className="text-foreground">Cycling computers</strong> — Wahoo, Hammerhead,
        ...
        <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
          ...
          <ul className="ml-4 list-disc space-y-1">
            <li>
              ...
              <code className="rounded bg-muted px-1 text-xs">.jpeg</code>) or HEIC format
            </li>
            <li>
          ...
          <Callout>
            <strong>Photos not showing up?</strong> The most common reasons: no tracks loaded yet,
            photo has no timestamp (screenshot or edited photo), or the photo was taken more than 5
            minutes before or after any tracked activity.
          </Callout>
        </div>
      </PageSection>
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          <div>
            ...
            <p>
              ...
              Open this page in your device's native browser —{" "}
              <strong className="text-foreground">Safari</strong> on iOS or{" "}
              <strong className="text-foreground">Chrome</strong> on Android — for full
              functionality.
            </p>
          </div>
          <div>
            <p className="mb-1 font-medium text-foreground">Track looks wrong or incomplete</p>
            <p>
              Some apps trim GPS data when exporting. Try exporting as a different format (e.g.
              FIT instead of GPX from Garmin Connect) or use the original file from your device if
              available.
            </p>
          </div>
          <div>
      ...
      <div className="pt-4 text-center">
        <AppLink to="/" variant="nav">Back to map</AppLink>
      </div>
    </PageShell>
  )
}
